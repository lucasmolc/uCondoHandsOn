<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HandsOnUCondo.Login.Register.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div style="display: flex; align-items: center; flex-direction: column; height: 100vh; justify-content: center;">
            ...
            <div class="col-12" style="display: flex; margin-top: 5px; align-items: center; justify-content: center;">
                <asp:Label ID="lblName" runat="server" Text="Nome" CssClass="m-2" ForeColor="135,113,209"></asp:Label>
                <asp:TextBox ID="TbName" runat="server" CssClass="text-black rounded-2 text-center" Height="32px" Width="290px"></asp:TextBox>
            </div>
            <div class="col-12" style="display: flex; margin-top: 5px; align-items: center; justify-content: center;">
            ...
            <div class="col-12" style="display: flex; margin-top: 5px; align-items: center; justify-content: center;">
                <asp:Label ID="lblCPF" runat="server" Text="CPF" CssClass="mt-2 mb-2 mx-3" ForeColor="135,113,209"></asp:Label>
                <asp:TextBox ID="TbCPF" runat="server" CssClass="text-black rounded-2 text-center" Height="32px" Width="290px"></asp:TextBox>
            </div>
            <div class="col-12" style="display: flex; margin-top: 5px; align-items: center; justify-content: center;">
            ...
            <div class="col-12 gap-1" style="display: flex; margin-top: 20px; align-items: center; justify-content: center;">
                <asp:Button ID="btnCancel" runat="server" Text="Voltar" CssClass="rounded-2 text-center" Height="40px" Width="175px" BackColor="White" ForeColor="135,113,209" OnClick="btnCancel_Click" />
                <asp:Button ID="btnRegister" runat="server" Text="Registrar" CssClass="text-white rounded-2 text-center" Height="40px" Width="175px" BackColor="135,113,209" OnClick="btnRegister_Click" />
            </div>
        </div>
    </form>
