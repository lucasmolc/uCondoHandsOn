                                ...
                                <div class="col" style="margin-top: 5px; margin-right: 15px;">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <asp:TextBox ID="tbIdFinancesFilter" CssClass="form-control rounded-2"  runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <asp:TextBox ID="tbDescriptionFilter" CssClass="form-control rounded-2"  runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <asp:DropDownList ID="ddlStatusFilter" CssClass="form-control rounded-2"  runat="server">
                                    ...
                                    <div class="row gap-2" style="display: flex; flex-wrap: wrap; flex-direction: row; justify-content: flex-start;">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-black fw-semibold" for="nameField">Status</label>
                                                <div class="input-group">
                                                    <asp:DropDownList ID="ddlStatus" CssClass="form-control rounded-2"  runat="server"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <asp:TextBox ID="tbDescription" CssClass="form-control rounded-2"  runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <asp:TextBox ID="tbValue" CssClass="form-control rounded-2"  runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <asp:TextBox ID="tbPeriod" CssClass="form-control rounded-2"  runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <asp:DropDownList ID="ddlType" CssClass="form-control rounded-2"  runat="server">
